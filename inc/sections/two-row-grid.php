...
<?php if ( get_theme_mod('neomax_below_slider_enable', 'enable') !== 'disable' ) : ?>

    <div class="slider-wrapper23 two-row-grid-section container">
        <div class="section-title"><?php echo esc_html(get_theme_mod('neomax_below_slider_title', esc_html__('New Releases', 'neomax'))); ?></div>
        <div class="neomax_slides ">
            <?php
            $neomax_image_size = "neomax-twogrid-image";
            $neomax_number = get_theme_mod('neomax_below_slider_posts', 16); // default to 16 posts
            $neomax_category = get_theme_mod('neomax_below_slider_category');
                    ...
                    <div class="slide-wrap">
                        ...
                        <div class="feat-item-wrapper">
                            ...
                            <div class="slider-meta">
                                <div class="post-date">
                                    <a href="<?php the_permalink(); ?>"><?php echo neomax_time_ago_custom(get_the_date('c')); ?></a>
                                </div>
