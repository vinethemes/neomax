...
<?php if ( get_theme_mod('neomax_highlight_slider_enable', 'enable') !== 'disable' ) : ?>

    <div class="slider-wrapper23 highlight-slider-section container">
        
        <div class="section-title">
            <?php echo esc_html(get_theme_mod('neomax_highlight_slider_title', esc_html__('Highlights', 'neomax'))); ?>
        </div>

        <div class="neomax_slides highlight-slider-grid">
            <?php
            $neomax_image_size = "neomax-slider-image";
            $neomax_number     = get_theme_mod('neomax_highlight_slider_posts', 10);
            $neomax_category   = get_theme_mod('neomax_highlight_slider_category');
